...
from util.common import compose_dynamically_and_train, compose_dynamically_and_train_approach2
...
for rpi in range(total_repeat):
    ...
    for _cmb in range(len(comboList)):
        ...
        xT, yT, xt, yt, comboKey, labels, num_classes = combine_for_reuse(tmod, data, num_sample=num_sample)

        yT = to_categorical(yT)
        modScore, modularTime = compose_dynamically_and_train_approach2(modules, xT, yT, xt, yt, nb_classes=num_classes)
